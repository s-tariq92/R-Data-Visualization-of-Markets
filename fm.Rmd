...
ggplot(data=state, aes(x=State, y=Total)) +
...
ggplot(data=Region, aes(x=region, y=Total)) +
...
ggplot(data=state, aes(x=State, y=perpop)) +
...
ggplot(groups, aes(x=Group, y=Total)) +
geom_bar(stat="identity", fill=alpha("salmon"))+
  ggtitle("Number of Markets Selling Each Product Type")+
  xlab("Product Group")+ylab("Number of Markets")+
  geom_text(aes(label=Total), angle = 0, hjust=0.5, vjust=-0.75, color="black",position = position_dodge(0.9), size=3.0)
